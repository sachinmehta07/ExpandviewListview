package com.example.expandviewlistview;
...
public class CustomizedExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        ImageView groupIndicatorImageView = convertView.findViewById(R.id.group_indicator);
        if (isExpanded) {
            groupIndicatorImageView.setImageResource(R.drawable.baseline_expand_less_24);
        } else {
            groupIndicatorImageView.setImageResource(R.drawable.baseline_expand_more_24);
        }
